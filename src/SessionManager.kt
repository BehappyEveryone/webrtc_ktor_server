...
object SessionManager {
    ...
    fun onSessionStarted(sessionId: UUID, session: DefaultWebSocketServerSession) {
        sessionManagerScope.launch {
            mutex.withLock {
                ...
                notifyOneAboutStateUpdate(session)
            }
        }
    }
    ...
    private fun notifyOneAboutStateUpdate(session: DefaultWebSocketServerSession) {
        session.send("${MessageType.STATE} $sessionState")
    }
